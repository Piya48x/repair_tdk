...
export const generateITRequestPDF = async (requestData, selectedRequest, currentUser) => {
    ...
    try {
        ...
        // ปรับขนาดโลโก้ให้ใหญ่ขึ้นจาก 35 เป็น 45
        const logoW = 45;
    ...
    const headerTextX = margin + 52; // ปรับระยะ X ของข้อความเล็กน้อยเพื่อให้สมดุลกับโลโก้ที่ใหญ่ขึ้น
    ...
    doc.setFont('Sarabun', 'bold');
    doc.text(`เลขที่อ้างอิง:`, pageW - margin - 28, y);
    doc.setFont('Sarabun', 'normal');
    ...
    doc.line(margin + 4, y, margin + 20, y);
